//=============================================================================
//  Binary file random, fast generator of incompressible random files.
...
// no need to initialize, we will use dirty memory as random seed.
...
int main( int argc, char* argv[] )
{
    ...
    int count;
    if ( argc != 4 ) {
        printf( "usage: bfrandom <FileName> <ChunkSize> <ChunkCount>\n" );
        return 1;
    }
